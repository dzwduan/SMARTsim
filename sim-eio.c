/* NOTE: EIO support has been disabled in this software release */
...
/*
 * sim-ckpt.c - checkpoint creation simulator
 *
...
#define SYSCALL(INST)							\
  ((trace_fd != NULL && !fastfwding)					\
   ? eio_write_trace(trace_fd, sim_pop_insn,				\
