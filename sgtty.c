...
int bsd_ioctl (int, int, void * );
static int tiocflush (int, int * );
static int tioclset (int, int * );
static int tioclget (int, int * );
static int tiocsltc (int, struct ltchars * );
static int tiocgltc (int, struct ltchars * );
static int tiocsetc (int, struct tchars * );
static int tiocgetc (int, struct tchars * );
static int tiocsetn (int, struct sgttyb * );
int stty (int, struct sgttyb * );
static int tiocset (int, struct sgttyb *, int );
int gtty (int, struct sgttyb * );
static inline int pchar (unsigned char );
static int bchar (unsigned char );
