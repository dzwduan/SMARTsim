...
extern struct power_stat_backup_t *power_stats_backup;

/* Called to copy power statistics into a "backup" buffer after measurement */
void power_backup_stats();

/* Called to copy power statistics into a "backup" buffer after measurement */
void power_alloc_stats();

/* Called to copy power statistics from a "backup" buffer before measurement */
void power_restore_stats();
