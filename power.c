...
#endif /* CMU_MINIMAL_WATTCH */

double rename_power_cc3=0;
double bpred_power_cc3=0;
double window_power_cc3=0;
double lsq_power_cc3=0;
double regfile_power_cc3=0;
double icache_power_cc3=0;
double dcache_power_cc3=0;
double dcache2_power_cc3=0;
double alu_power_cc3=0;
double resultbus_power_cc3=0;
double clock_power_cc3=0;
...
power_reg_stats(struct stat_sdb_t *sdb)	/* stats database */
{
  ...
  stat_reg_formula(sdb, "avg_rename_power", "avg power usage of rename unit", "rename_power/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_bpred_power", "avg power usage of bpred unit", "bpred_power/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_window_power", "avg power usage of instruction window", "window_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_lsq_power", "avg power usage of lsq", "lsq_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_regfile_power", "avg power usage of arch. regfile", "regfile_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_icache_power", "avg power usage of icache", "icache_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache_power", "avg power usage of dcache", "dcache_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache2_power", "avg power usage of dcache2", "dcache2_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_alu_power", "avg power usage of alu", "alu_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_falu_power", "avg power usage of falu", "falu_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_resultbus_power", "avg power usage of resultbus", "resultbus_power/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_clock_power", "avg power usage of clock", "clock_power/sim_meas_cycle",  NULL);
  ...
  stat_reg_formula(sdb, "avg_fetch_power", "average power of fetch unit per cycle", "(icache_power + bpred_power)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_dispatch_power", "average power of dispatch unit per cycle", "(rename_power)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_issue_power", "average power of issue unit per cycle", "(resultbus_power + alu_power + dcache_power + dcache2_power + window_power + lsq_power)/ sim_meas_cycle", /* format */NULL);
  ...
  stat_reg_formula(sdb, "avg_total_power_cycle", "average total power per cycle","(rename_power + bpred_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power + dcache2_power)/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_cycle_nofp_nod2", "average total power per cycle","(rename_power + bpred_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power - falu_power )/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn", "average total power per insn","(rename_power + bpred_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power + dcache2_power)/sim_meas_insn", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_nofp_nod2", "average total power per insn","(rename_power + bpred_power + window_power + lsq_power + regfile_power + icache_power + resultbus_power + clock_power + alu_power + dcache_power - falu_power )/sim_meas_insn", NULL);
  ...
  stat_reg_formula(sdb, "avg_rename_power_cc1", "avg power usage of rename unit_cc1", "rename_power_cc1/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_bpred_power_cc1", "avg power usage of bpred unit_cc1", "bpred_power_cc1/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_window_power_cc1", "avg power usage of instruction window_cc1", "window_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_lsq_power_cc1", "avg power usage of lsq_cc1", "lsq_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_regfile_power_cc1", "avg power usage of arch. regfile_cc1", "regfile_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_icache_power_cc1", "avg power usage of icache_cc1", "icache_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache_power_cc1", "avg power usage of dcache_cc1", "dcache_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache2_power_cc1", "avg power usage of dcache2_cc1", "dcache2_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_alu_power_cc1", "avg power usage of alu_cc1", "alu_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_resultbus_power_cc1", "avg power usage of resultbus_cc1", "resultbus_power_cc1/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_clock_power_cc1", "avg power usage of clock_cc1", "clock_power_cc1/sim_meas_cycle",  NULL);
  ...
  stat_reg_formula(sdb, "avg_fetch_power_cc1", "average power of fetch unit per cycle_cc1", "(icache_power_cc1 + bpred_power_cc1)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_dispatch_power_cc1", "average power of dispatch unit per cycle_cc1", "(rename_power_cc1)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_issue_power_cc1", "average power of issue unit per cycle_cc1", "(resultbus_power_cc1 + alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1 + lsq_power_cc1 + window_power_cc1)/ sim_meas_cycle", /* format */NULL);
  ...
  stat_reg_formula(sdb, "avg_total_power_cycle_cc1", "average total power per cycle_cc1","(rename_power_cc1 + bpred_power_cc1 + lsq_power_cc1 + window_power_cc1 + regfile_power_cc1 + icache_power_cc1 + resultbus_power_cc1 + clock_power_cc1 + alu_power_cc1 + dcache_power_cc1 +dcache2_power_cc1)/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc1", "average total power per insn_cc1","(rename_power_cc1 + bpred_power_cc1 + lsq_power_cc1 + window_power_cc1 + regfile_power_cc1 + icache_power_cc1 + resultbus_power_cc1 + clock_power_cc1 +  alu_power_cc1 + dcache_power_cc1 + dcache2_power_cc1)/sim_meas_insn", NULL);
  ...
  stat_reg_formula(sdb, "avg_rename_power_cc2", "avg power usage of rename unit_cc2", "rename_power_cc2/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_bpred_power_cc2", "avg power usage of bpred unit_cc2", "bpred_power_cc2/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_window_power_cc2", "avg power usage of instruction window_cc2", "window_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_lsq_power_cc2", "avg power usage of instruction lsq_cc2", "lsq_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_regfile_power_cc2", "avg power usage of arch. regfile_cc2", "regfile_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_icache_power_cc2", "avg power usage of icache_cc2", "icache_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache_power_cc2", "avg power usage of dcache_cc2", "dcache_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache2_power_cc2", "avg power usage of dcache2_cc2", "dcache2_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_alu_power_cc2", "avg power usage of alu_cc2", "alu_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_resultbus_power_cc2", "avg power usage of resultbus_cc2", "resultbus_power_cc2/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_clock_power_cc2", "avg power usage of clock_cc2", "clock_power_cc2/sim_meas_cycle",  NULL);
  ...
  stat_reg_formula(sdb, "avg_fetch_power_cc2", "average power of fetch unit per cycle_cc2", "(icache_power_cc2 + bpred_power_cc2)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_dispatch_power_cc2", "average power of dispatch unit per cycle_cc2", "(rename_power_cc2)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_issue_power_cc2", "average power of issue unit per cycle_cc2", "(resultbus_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2 + lsq_power_cc2 + window_power_cc2)/ sim_meas_cycle", /* format */NULL);
  ...
  stat_reg_formula(sdb, "avg_total_power_cycle_cc2", "average total power per cycle_cc2","(rename_power_cc2 + bpred_power_cc2 + lsq_power_cc2 + window_power_cc2 + regfile_power_cc2 + icache_power_cc2 + resultbus_power_cc2 + clock_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2)/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc2", "average total power per insn_cc2","(rename_power_cc2 + bpred_power_cc2 + lsq_power_cc2 + window_power_cc2 + regfile_power_cc2 + icache_power_cc2 + resultbus_power_cc2 + clock_power_cc2 + alu_power_cc2 + dcache_power_cc2 + dcache2_power_cc2)/sim_meas_insn", NULL);
#endif /* CMU_MINIMAL_WATTCH */
  ...
  stat_reg_formula(sdb, "avg_rename_power_cc3", "avg power usage of rename unit_cc3", "rename_power_cc3/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_bpred_power_cc3", "avg power usage of bpred unit_cc3", "bpred_power_cc3/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_window_power_cc3", "avg power usage of instruction window_cc3", "window_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_lsq_power_cc3", "avg power usage of instruction lsq_cc3", "lsq_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_regfile_power_cc3", "avg power usage of arch. regfile_cc3", "regfile_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_icache_power_cc3", "avg power usage of icache_cc3", "icache_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache_power_cc3", "avg power usage of dcache_cc3", "dcache_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache2_power_cc3", "avg power usage of dcache2_cc3", "dcache2_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_alu_power_cc3", "avg power usage of alu_cc3", "alu_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_resultbus_power_cc3", "avg power usage of resultbus_cc3", "resultbus_power_cc3/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_clock_power_cc3", "avg power usage of clock_cc3", "clock_power_cc3/sim_meas_cycle",  NULL);
  ...
  stat_reg_formula(sdb, "avg_fetch_power_cc3", "average power of fetch unit per cycle_cc3", "(icache_power_cc3 + bpred_power_cc3)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_dispatch_power_cc3", "average power of dispatch unit per cycle_cc3", "(rename_power_cc3)/ sim_meas_cycle", /* format */NULL);

  stat_reg_formula(sdb, "avg_issue_power_cc3", "average power of issue unit per cycle_cc3", "(resultbus_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3 + lsq_power_cc3 + window_power_cc3)/ sim_meas_cycle", /* format */NULL);
  ...
  stat_reg_formula(sdb, "avg_total_power_cycle_cc3", "average total power per cycle_cc3","(rename_power_cc3 + bpred_power_cc3 + lsq_power_cc3 + window_power_cc3 + regfile_power_cc3 + icache_power_cc3 + resultbus_power_cc3 + clock_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3)/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_total_power_insn_cc3", "average total power per insn_cc3","(rename_power_cc3 + bpred_power_cc3 + lsq_power_cc3 + window_power_cc3 + regfile_power_cc3 + icache_power_cc3 + resultbus_power_cc3 + clock_power_cc3 + alu_power_cc3 + dcache_power_cc3 + dcache2_power_cc3)/sim_meas_insn", NULL);
  ...
  stat_reg_formula(sdb, "avg_rename_access", "avg number accesses of rename unit", "total_rename_access/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_bpred_access", "avg number accesses of bpred unit", "total_bpred_access/sim_meas_cycle", NULL);

  stat_reg_formula(sdb, "avg_window_access", "avg number accesses of instruction window", "total_window_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_lsq_access", "avg number accesses of lsq", "total_lsq_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_regfile_access", "avg number accesses of arch. regfile", "total_regfile_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_icache_access", "avg number accesses of icache", "total_icache_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache_access", "avg number accesses of dcache", "total_dcache_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_dcache2_access", "avg number accesses of dcache2", "total_dcache2_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_alu_access", "avg number accesses of alu", "total_alu_access/sim_meas_cycle",  NULL);

  stat_reg_formula(sdb, "avg_resultbus_access", "avg number accesses of resultbus", "total_resultbus_access/sim_meas_cycle",  NULL);
...
struct power_stat_backup_t *power_stats_backup;

/* Called to copy power statistics into a "backup" buffer after measurement */
void power_alloc_stats() {
  power_stats_backup = calloc(1, sizeof(struct power_stat_backup_t));
}

/* Called to copy powertatistics into a "backup" buffesurement */
void power_backup_stats(int stratum) {

    power_stats_backup->rename_power    = rename_power;
    power_stats_backup->bpred_power     = bpred_power;
    power_stats_backup->window_power    = window_power;
    power_stats_backup->lsq_power       = lsq_power;
    power_stats_backup->regfile_power   = regfile_power;
    power_stats_backup->icache_power    = icache_power;
    power_stats_backup->dcache_power    = dcache_power;
    power_stats_backup->dcache2_power   = dcache2_power;
    power_stats_backup->alu_power       = alu_power;
    power_stats_backup->falu_power      = falu_power;
    power_stats_backup->resultbus_power = resultbus_power;
    power_stats_backup->clock_power     = clock_power;

#ifndef CMU_MINIMAL_WATTCH
    power_stats_backup->rename_power_cc1     = rename_power_cc1;
    power_stats_backup->bpred_power_cc1      = bpred_power_cc1;
    power_stats_backup->window_power_cc1     = window_power_cc1;
    power_stats_backup->lsq_power_cc1        = lsq_power_cc1;
    power_stats_backup->regfile_power_cc1    = regfile_power_cc1;
    power_stats_backup->icache_power_cc1     = icache_power_cc1;
    power_stats_backup->dcache_power_cc1     = dcache_power_cc1;
    power_stats_backup->dcache2_power_cc1    = dcache2_power_cc1;
    power_stats_backup->alu_power_cc1        = alu_power_cc1;
    power_stats_backup->resultbus_power_cc1  = resultbus_power_cc1;
    power_stats_backup->clock_power_cc1      = clock_power_cc1;

    power_stats_backup->rename_power_cc2     = rename_power_cc2;
    power_stats_backup->bpred_power_cc2      = bpred_power_cc2;
    power_stats_backup->window_power_cc2     = window_power_cc2;
    power_stats_backup->lsq_power_cc2        = lsq_power_cc2;
    power_stats_backup->regfile_power_cc2    = regfile_power_cc2;
    power_stats_backup->icache_power_cc2     = icache_power_cc2;
    power_stats_backup->dcache_power_cc2     = dcache_power_cc2;
    power_stats_backup->dcache2_power_cc2    = dcache2_power_cc2;
    power_stats_backup->alu_power_cc2        = alu_power_cc2;
    power_stats_backup->resultbus_power_cc2  = resultbus_power_cc2;
    power_stats_backup->clock_power_cc2      = clock_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */

    power_stats_backup->rename_power_cc3     = rename_power_cc3;
    power_stats_backup->bpred_power_cc3      = bpred_power_cc3;
    power_stats_backup->window_power_cc3     = window_power_cc3;
    power_stats_backup->lsq_power_cc3        = lsq_power_cc3;
    power_stats_backup->regfile_power_cc3    = regfile_power_cc3;
    power_stats_backup->icache_power_cc3     = icache_power_cc3;
    power_stats_backup->dcache_power_cc3     = dcache_power_cc3;
    power_stats_backup->dcache2_power_cc3    = dcache2_power_cc3;
    power_stats_backup->alu_power_cc3        = alu_power_cc3;
    power_stats_backup->resultbus_power_cc3  = resultbus_power_cc3;
    power_stats_backup->clock_power_cc3      = clock_power_cc3;

#ifndef CMU_MINIMAL_WATTCH
    power_stats_backup->last_single_total_cycle_power_cc1 = last_single_total_cycle_power_cc1;
    power_stats_backup->last_single_total_cycle_power_cc2 = last_single_total_cycle_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */
    power_stats_backup->last_single_total_cycle_power_cc3 = last_single_total_cycle_power_cc3;

#ifndef CMU_MINIMAL_WATTCH
    power_stats_backup->max_cycle_power_cc1 = max_cycle_power_cc1;
    power_stats_backup->max_cycle_power_cc2 = max_cycle_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */
    power_stats_backup->max_cycle_power_cc3 = max_cycle_power_cc3;

    power_stats_backup->total_rename_access    = total_rename_access   ;
    power_stats_backup->total_bpred_access     = total_bpred_access    ;
    power_stats_backup->total_window_access    = total_window_access   ;
    power_stats_backup->total_lsq_access       = total_lsq_access      ;
    power_stats_backup->total_regfile_access   = total_regfile_access  ;
    power_stats_backup->total_icache_access    = total_icache_access   ;
    power_stats_backup->total_dcache_access    = total_dcache_access   ;
    power_stats_backup->total_dcache2_access   = total_dcache2_access  ;
    power_stats_backup->total_alu_access       = total_alu_access      ;
    power_stats_backup->total_resultbus_access = total_resultbus_access;

    power_stats_backup->max_rename_access    = max_rename_access   ;
    power_stats_backup->max_bpred_access     = max_bpred_access    ;
    power_stats_backup->max_window_access    = max_window_access   ;
    power_stats_backup->max_lsq_access       = max_lsq_access      ;
    power_stats_backup->max_regfile_access   = max_regfile_access  ;
    power_stats_backup->max_icache_access    = max_icache_access   ;
    power_stats_backup->max_dcache_access    = max_dcache_access   ;
    power_stats_backup->max_dcache2_access   = max_dcache2_access  ;
    power_stats_backup->max_alu_access       = max_alu_access      ;
    power_stats_backup->max_resultbus_access = max_resultbus_access;

}

/* Called to copy power statistics fup" buffer before measurement */
void power_restore_stats(int stratum) {

    rename_power    = power_stats_backup->rename_power;
    bpred_power     = power_stats_backup->bpred_power;
    window_power    = power_stats_backup->window_power;
    lsq_power       = power_stats_backup->lsq_power;
    regfile_power   = power_stats_backup->regfile_power;
    icache_power    = power_stats_backup->icache_power;
    dcache_power    = power_stats_backup->dcache_power;
    dcache2_power   = power_stats_backup->dcache2_power;
    alu_power       = power_stats_backup->alu_power;
    falu_power      = power_stats_backup->falu_power;
    resultbus_power = power_stats_backup->resultbus_power;
    clock_power     = power_stats_backup->clock_power;

#ifndef CMU_MINIMAL_WATTCH
    rename_power_cc1     = power_stats_backup->rename_power_cc1;
    bpred_power_cc1      = power_stats_backup->bpred_power_cc1;
    window_power_cc1     = power_stats_backup->window_power_cc1;
    lsq_power_cc1        = power_stats_backup->lsq_power_cc1;
    regfile_power_cc1    = power_stats_backup->regfile_power_cc1;
    icache_power_cc1     = power_stats_backup->icache_power_cc1;
    dcache_power_cc1     = power_stats_backup->dcache_power_cc1;
    dcache2_power_cc1    = power_stats_backup->dcache2_power_cc1;
    alu_power_cc1        = power_stats_backup->alu_power_cc1;
    resultbus_power_cc1  = power_stats_backup->resultbus_power_cc1;
    clock_power_cc1      = power_stats_backup->clock_power_cc1;

    rename_power_cc2     = power_stats_backup->rename_power_cc2;
    bpred_power_cc2      = power_stats_backup->bpred_power_cc2;
    window_power_cc2     = power_stats_backup->window_power_cc2;
    lsq_power_cc2        = power_stats_backup->lsq_power_cc2;
    regfile_power_cc2    = power_stats_backup->regfile_power_cc2;
    icache_power_cc2     = power_stats_backup->icache_power_cc2;
    dcache_power_cc2     = power_stats_backup->dcache_power_cc2;
    dcache2_power_cc2    = power_stats_backup->dcache2_power_cc2;
    alu_power_cc2        = power_stats_backup->alu_power_cc2;
    resultbus_power_cc2  = power_stats_backup->resultbus_power_cc2;
    clock_power_cc2      = power_stats_backup->clock_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */

    rename_power_cc3     = power_stats_backup->rename_power_cc3;
    bpred_power_cc3      = power_stats_backup->bpred_power_cc3;
    window_power_cc3     = power_stats_backup->window_power_cc3;
    lsq_power_cc3        = power_stats_backup->lsq_power_cc3;
    regfile_power_cc3    = power_stats_backup->regfile_power_cc3;
    icache_power_cc3     = power_stats_backup->icache_power_cc3;
    dcache_power_cc3     = power_stats_backup->dcache_power_cc3;
    dcache2_power_cc3    = power_stats_backup->dcache2_power_cc3;
    alu_power_cc3        = power_stats_backup->alu_power_cc3;
    resultbus_power_cc3  = power_stats_backup->resultbus_power_cc3;
    clock_power_cc3      = power_stats_backup->clock_power_cc3;

#ifndef CMU_MINIMAL_WATTCH
    last_single_total_cycle_power_cc1 = power_stats_backup->last_single_total_cycle_power_cc1;
    last_single_total_cycle_power_cc2 = power_stats_backup->last_single_total_cycle_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */
    last_single_total_cycle_power_cc3 = power_stats_backup->last_single_total_cycle_power_cc3;

#ifndef CMU_MINIMAL_WATTCH
    max_cycle_power_cc1 = power_stats_backup->max_cycle_power_cc1;
    max_cycle_power_cc2 = power_stats_backup->max_cycle_power_cc2;
#endif /* CMU_MINIMAL_WATTCH */
    max_cycle_power_cc3 = power_stats_backup->max_cycle_power_cc3;

    total_rename_access    = power_stats_backup->total_rename_access   ;
    total_bpred_access     = power_stats_backup->total_bpred_access    ;
    total_window_access    = power_stats_backup->total_window_access   ;
    total_lsq_access       = power_stats_backup->total_lsq_access      ;
    total_regfile_access   = power_stats_backup->total_regfile_access  ;
    total_icache_access    = power_stats_backup->total_icache_access   ;
    total_dcache_access    = power_stats_backup->total_dcache_access   ;
    total_dcache2_access   = power_stats_backup->total_dcache2_access  ;
    total_alu_access       = power_stats_backup->total_alu_access      ;
    total_resultbus_access = power_stats_backup->total_resultbus_access;

    max_rename_access    = power_stats_backup->max_rename_access   ;
    max_bpred_access     = power_stats_backup->max_bpred_access    ;
    max_window_access    = power_stats_backup->max_window_access   ;
    max_lsq_access       = power_stats_backup->max_lsq_access      ;
    max_regfile_access   = power_stats_backup->max_regfile_access  ;
    max_icache_access    = power_stats_backup->max_icache_access   ;
    max_dcache_access    = power_stats_backup->max_dcache_access   ;
    max_dcache2_access   = power_stats_backup->max_dcache2_access  ;
    max_alu_access       = power_stats_backup->max_alu_access      ;
    max_resultbus_access = power_stats_backup->max_resultbus_access;
