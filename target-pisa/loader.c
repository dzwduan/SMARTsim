 ...
 *
 * $Id: loader.c,v 1.1.28.1 2003/05/30 17:34:55 twenisch Exp $
 *
 * $Log: loader.c,v $
 * Revision 1.1.28.1  2003/05/30 17:34:55  twenisch
 * Fixes to make PISA target work
 *
	     ...
	     int zero_bss_segs)		/* zero uninit data segment? */
{
  ...
  if (/* eio_valid(fname) EIO support disabled */ 0)
    {
      if (argc != 1)
	{
