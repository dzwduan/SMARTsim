 ...
 *
 * $Id: syscall.c,v 1.2.2.1 2002/09/22 01:35:59 twenisch Exp $
 *
 * $Log: syscall.c,v $
 * Revision 1.2.2.1  2002/09/22 01:35:59  twenisch
 * Commit of sampling support.  Sampling support merged from old code base.
 *
 * Revision 1.2  2002/09/17 22:05:29  jsmolens
 * Added handlers for umask() and rename()
 *
 * Revision 1.1  2002/09/05 20:26:20  twenisch
	    ...
	    int traceable)		/* traceable system call? */
{
  ...
  switch (syscode)
	...
	if (!local_req)
      ...
      /* JCS - added the umask system call
       *
       *  mode_t umask(mode_t mask);
       */
    case SS_SYS_umask:
      {
	regs->regs_R[2] = umask ( regs->regs_R[4] );
